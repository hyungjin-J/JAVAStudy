...
public class A_If {
	 ...
	 *  순차적인 흐름을 바꿀 때 제어문,반복문을 사용하여 제어 가능
	 *  
	 *  조건문의 종류 : if, switch
	 *  -if
	 *  	[1] 단독 if 문
	 *  					if (조건식) {
	 *  								// 조건식 결과가 참(true)일 때 실행하는 내용
	 *  							   }
	 *  	[2] if ~ else 문
	 *  if (조건식) {
	 ...
	 *   	[3] if ~ else if ~ else 문
	 *   if (조건식1) {
	 *   /조건식 1의 결과가 true 일 때 실행할 내용
	 *   } else if (조건식2) {
	 *   /조건식 1이 false 이며 조건식 2가 true 일 때 실행할 내용
	 *   } else {
	 *   /조건식 1, 2 모두 false 일 때 실행할 내용
	 *   
	 *  
	 */						
