...
public class IO001_File {
	...
	public static void test1() {
		...
		// -> 파일명만 전달하여 객체 생성 , 아직 실제로 존재하지는 않는 파일
		...
		//존재하지 않는 경로에 파일 객체 생성 -> 예외(오류) 발생
		//이런 경우 폴더를 먼저 생성하고 그 다음에 파일 생성해야 한다.
		...
		try {
			...
			//파일인지 확인(폴더인지 파일인지) : isFile() <<<< boolean
